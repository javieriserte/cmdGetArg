...
public class CommandLine {
	...
	////////////////////////
	// Instance Variables
	protected List<ArgOption<? extends Object>> options = new Vector<ArgOption<? extends Object>>();
	 ...
	 * 
	 * Read the command line arguments. If an exception occurs the program is terminated
	...
	public boolean read(String[] arg) throws IncorrectCommandLineException {
		...
		do {
			...
			if (next==null) {
				...
				if (!cm.equals("") && currentOption!=null)	currentOption.parseInputText(cm);
